...
public class ProgressBar {
    ...
    private int maxValue;       //==колличеству нужных очков
    ...
    private int[][] createColoredMatrix(int width, int height, Color color) {       //создание матрицы заполненной значением номера цвета
